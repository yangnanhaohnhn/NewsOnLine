...
class MineFragment : BaseFragment<FMinePresenter>(), FMineView {
    ...
    override fun changeTheme(isNight: Boolean) {
        if (isNight){
            mine_constraint_layout.setBackgroundColor(resources.getColor(R.color.backgroundColor))
        }else{
